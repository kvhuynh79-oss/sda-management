            ...
            <div className="space-y-4">
              ...
              >
                <div className="flex items-center gap-3 flex-1">
                  ...
                  <div>
                    <h4 className="text-white font-medium">PDF Templates</h4>
                    <p className="text-gray-400 text-sm mt-1">
                      Upload Canva-designed templates for Easy Read consent forms
                    </p>
                  </div>
                </div>
                <div className="flex items-center gap-2 text-gray-400">
              ...
              >
                <div className="flex items-center gap-3 flex-1">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-sm mt-1">
                      Export all organization data for compliance or migration
                    </p>
                  </div>
                </div>
                <div className="flex items-center gap-2 text-gray-400">
