export default function PropertiesLoading() {
  return (
    <div className="min-h-screen bg-gray-900" role="status" aria-label="Loading properties">
      {/* Header skeleton */}
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex justify-between items-center mb-8">
          <div>
            <div className="h-7 w-36 bg-gray-700 rounded animate-pulse mb-2" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {Array.from({ length: 6 }).map((_, i) => (
            <div key={i} className="bg-gray-800 rounded-lg p-6 border border-gray-700">
              <div className="h-5 w-40 bg-gray-700 rounded animate-pulse mb-3" />
              <div className="h-4 w-56 bg-gray-700/50 rounded animate-pulse mb-2" />
